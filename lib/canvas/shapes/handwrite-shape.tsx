 ...
 * Curves pass through midpoints between consecutive points,
 * creating smooth lines without heavy post-processing.
 */
function buildSmoothPath(
  ...
  // Catmull-Rom style: move to first point, then use quadratic beziers
  // through midpoints with control points at the actual data points
  ...
  // Quadratic beziers through midpoints, using actual points as control points
